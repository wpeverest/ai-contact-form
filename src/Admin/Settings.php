		...
		$settings = apply_filters(
			...
			array(
				...
				array(
					...
					'desc'     => sprintf( esc_html__( 'Please enter your API key of AI. <a href="%1$s" target="_blank">Learn More</a>', 'ai-contact-form' ), esc_url( 'https://docs.everestforms.net/docs/ai/' ) ),
